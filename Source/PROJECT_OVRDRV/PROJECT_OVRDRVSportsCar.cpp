...
#include "PROJECT_OVRDRVSportsCar.h"
#include "PROJECT_OVRDRVSportsWheelFront.h"
#include "PROJECT_OVRDRVSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

APROJECT_OVRDRVSportsCar::APROJECT_OVRDRVSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPROJECT_OVRDRVSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPROJECT_OVRDRVSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPROJECT_OVRDRVSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPROJECT_OVRDRVSportsWheelRear::StaticClass();
