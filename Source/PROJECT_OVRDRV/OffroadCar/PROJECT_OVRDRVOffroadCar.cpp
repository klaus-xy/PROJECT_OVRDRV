...
#include "PROJECT_OVRDRVOffroadCar.h"
#include "PROJECT_OVRDRVOffroadWheelFront.h"
#include "PROJECT_OVRDRVOffroadWheelRear.h"
...
APROJECT_OVRDRVOffroadCar::APROJECT_OVRDRVOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UPROJECT_OVRDRVOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UPROJECT_OVRDRVOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UPROJECT_OVRDRVOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UPROJECT_OVRDRVOffroadWheelRear::StaticClass();
